...
import kr.iamport.cordova.PaymentScheme;
...
public class KcpUrlSchemeHandler extends IamportUrlSchemeHandler {

    public KcpUrlSchemeHandler(CordovaInterface cordova) {
        super(cordova);
    }
